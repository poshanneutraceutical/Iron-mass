...
export default function Distributor() {
  ...
  return (
    ...
    <section
      id="distributor"
      className="relative py-28 bg-[#090909] overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div
            ...
            <h2 className="mt-6 text-5xl md:text-7xl font-black uppercase leading-none">
              ...
              <span className="block text-[#d4af37]">
                ...
                IronMass Distributor

              </span>

            </h2>

            <div className="w-32 h-[3px] bg-[#d4af37] rounded-full mt-8 mb-8" />

            <p className="text-gray-400 text-lg leading-8 max-w-xl">

              Join the IronMass distribution network and grow with one of
          ...
          <div
           data-reveal
            data-delay={100}
          className="rounded-3xl border border-[#d4af37]/20 bg-[#111111] p-8 md:p-10 shadow-[0_0_45px_rgba(212,175,55,0.08)]">
            ...
            {status === "success" ? (
              ...
              <div className="py-16 text-center animate-fadeIn">
                ...
                <CheckCircle2
                  size={70}
                  className="mx-auto text-[#d4af37] mb-8"
                />
                ...
                <p className="text-gray-400 max-w-md mx-auto leading-8">
                  ...
                  Thank you for your interest in becoming an IronMass
                  Distributor.
                ...
                <button
                  ...
                  className="mt-10 px-8 py-4 rounded-xl bg-[#d4af37] text-black font-bold uppercase tracking-wider hover:bg-[#f1c94b] transition-all"
                >
              ...
              >
                ...
                <div>
                  ...
                  <span className="uppercase tracking-[0.35em] text-[#d4af37] text-xs">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-[#d4af37] text-black font-bold uppercase tracking-[0.2em] hover:bg-[#f1c94b] transition-all disabled:opacity-60 flex justify-center items-center gap-3"
                >
