  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at top, rgba(212,175,55,0.08), transparent 65%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at bottom, rgba(212,175,55,.08), transparent 75%)",
        }}
      />
    </div>
  );
