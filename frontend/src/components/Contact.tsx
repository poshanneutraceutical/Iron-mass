      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-400 leading-8">
            ...
            Our IronMass support team is always
            ready to help you.
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-12 rounded-3xl border border-[#d4af37]/20 bg-[#111111] p-8">
                  ...
                  <span className="text-[#d4af37]">
                    Closed
                      ...
                      <div className="relative">
                        ...
                        <div className="relative bg-[#111111] border border-[#d4af37]/20 rounded-3xl p-8 lg:p-10">
                          ...
                          {status === "success" ? (
                            ...
                            <div className="text-center py-14">
                              ...
                              <p className="text-gray-400 mb-8">
                                Thank you for contacting IronMass.
                                <br />
