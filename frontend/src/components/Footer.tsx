...
export default function Footer() {
  return (
    <footer className="relative bg-[#050505] border-t border-[#d4af37]/20 pt-20 pb-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-11 h-11 rounded-xl border border-[#d4af37]/20 flex items-center justify-center hover:bg-[#d4af37] hover:text-black transition-all duration-200"
              >
                <Instagram size={18} />
              </a>
          ...
          <div>
            ...
            <h3 className="text-[#d4af37] text-lg font-bold uppercase tracking-wider mb-6">
          ...
          <div>
            ...
            {/* Contact */}
                                 ...
                                 <div className="border-t border-[#d4af37]/20 pt-8 flex flex-col lg:flex-row items-center justify-between gap-6">

                                   <p className="text-gray-500 text-sm text-center lg:text-left">

                                     © {new Date().getFullYear()} IronMass Nutrition.
                                     All Rights Reserved.
